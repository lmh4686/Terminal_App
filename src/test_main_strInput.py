...
class TestGetUserChoice:
    ...
    def test_str_valid_input(self, monkeypatch):
        ...
        assert module.get_user_choice('a', ['1', '2', '3'])  # When input is '1'
        assert module.get_user_choice('a', ['1', '2', '3'])  # When input is '2'
        assert module.get_user_choice('a', ['1', '2', '3'])  # When input is '3'
    ...
    def test_str_invalid_input(self, monkeypatch):
        ...
        with pytest.raises(module.InputError):
            module.get_user_choice('a', ['1', '2', '3'])  # When input is '4'
            module.get_user_choice('a', ['1', '2', '3'])  # When input is 'a'
            module.get_user_choice('a', ['1', '2', '3'])  # When input is '!'
    ...
    def test_num_valid_input(self, monkeypatch):
        ...
        assert module.get_user_choice('a', range(1, 5, 1))  # When input is 1
    ...
    def test_num_smaller_input(self, monkeypatch):
        monkeypatch.setattr("builtins.input", fake_num_input)
        with pytest.raises(module.RangeError):
            assert module.get_user_choice('a', range(1, 5, 1))  # When input is 0
    ...
    def test_num_excess_input(self, monkeypatch):  # int input test
        monkeypatch.setattr("builtins.input", fake_num_input)
        with pytest.raises(module.ExcessError):
            assert module.get_user_choice('a', range(1, 5, 1))  # When input is 5
    ...
    def test_num_not_int_input(self, monkeypatch):  # int input test
        ...
        with pytest.raises(ValueError):
            assert module.get_user_choice('a', range(1, 5, 1))  # When input is 1.1
            assert module.get_user_choice('a', range(1, 5, 1))  # When input is 'a'
...
class TestBagAdd:
    ...
    def test_adding(self):
        assert module.bag_add('Wheat', 4) == 4  # Add 4 Wheat
        assert module.bag_add('Wheat', 4) == 8  # Add 4 more Wheat
        assert module.bag_add('Plum', 3) == 3  # Add 3 plum in empty bag
